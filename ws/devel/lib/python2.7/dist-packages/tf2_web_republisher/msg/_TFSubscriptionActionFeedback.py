...
"""autogenerated by genpy from tf2_web_republisher/TFSubscriptionActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TFSubscriptionActionFeedback(genpy.Message):
  _md5sum = "de686654be3ef0f8970616dd702bb360"
  _type = "tf2_web_republisher/TFSubscriptionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tf2_web_republisher/TFSubscriptionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TFSubscriptionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = tf2_web_republisher.msg.TFSubscriptionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = tf2_web_republisher.msg.TFSubscriptionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.feedback.transforms)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.transforms:
        _v1 = val1.header
        _x = _v1.seq
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.feedback.transforms.append(val1)
      return self
