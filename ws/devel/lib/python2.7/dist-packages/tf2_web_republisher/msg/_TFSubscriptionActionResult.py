...
"""autogenerated by genpy from tf2_web_republisher/TFSubscriptionActionResult.msg. Do not edit."""
import codecs
import sys
...
class TFSubscriptionActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "tf2_web_republisher/TFSubscriptionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tf2_web_republisher/TFSubscriptionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TFSubscriptionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tf2_web_republisher.msg.TFSubscriptionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tf2_web_republisher.msg.TFSubscriptionResult()
